...
# CI-CORRECTIVE (Flight Recorder backup test collection) -- the actual
# implementation moved to core/memory_backup.py: it was always Qt-free,
# but living inside the ui.settings package meant importing it at all
# executed ui/settings/__init__.py's eager PySide6 imports, breaking
# collection in the PySide6-less CI job. Re-exported here under its
# original name so this module's own UI call site below and any other
# existing importer keep working unchanged -- pure extraction, no
# behavior change. See core/memory_backup.py's own docstring.
