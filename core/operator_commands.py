...
KNOWN_COMMANDS = {"status", "btw", "compact", "stop", "context"}
...
def command_help() -> str:
    return (
        "Available operator commands: /status · /btw <question> · /compact · "
        "/stop · /stop all · /context · /context status · /context rebuild"
    )
